...
rota.get("/api/v1/usuarios/:codigo", middleware, async (req, res) => {
...
rota.put(
  "/api/v1/usuarios/:codigo/alteraSenha",
  middleware,
  async (req, res) => {
...
rota.put(
  "/api/v1/usuarios/:codigo/alteraEmail",
  middleware,
  async (req, res) => {
    const { codigo } = req.params;
...
rota.put(
  "/api/v1/usuarios/:codigo/alteraInformacao",
  middleware,
  async (req, res) => {
    const { codigo } = req.params;
