...
create table usuario_periodo(
	...
	codigo_usuario int not null,
	constraint fk_codigo_periodo foreign key (codigo_periodo) references periodo (codigo),
	constraint fk_codigo_usuarioo foreign key (codigo_usuario) references usuario (codigo)
);

create table usuario_tipo_transporte(
	codigo int AUTO_INCREMENT primary key,
	codigo_tipo_transporte int not null,
	codigo_usuario int not null,
	constraint fk_codigo_tipo_transporte foreign key (codigo_tipo_transporte) references tipo_transporte (codigo),
	constraint fk_codigo_usuariooo_tipo_transporte foreign key (codigo_usuario) references usuario (codigo)
);
...
create table responsavel_escolar (
	codigo int AUTO_INCREMENT primary key,
	codigo_motorista int not null,
	codigo_periodo int not null,
...
create table aluno_responsavel_escolar(
	codigo int AUTO_INCREMENT primary key,
	codigo_escola int not null,
	codigo_periodo int not null,
	...
	constraint fk_codigo_responsavel_escolar foreign key (codigo_responsavel) references responsavel_escolar (codigo),
